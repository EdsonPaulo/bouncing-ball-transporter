...
public class BouncingBallGame extends JPanel implements Runnable, KeyListener {
    ...
    public BouncingBallGame() throws Exception {
        ...
        imgBackground = new ImageIcon("assets/images/Background.png").getImage();
    ...
    public void paintComponent(Graphics g) {
        ...
        g2D.drawImage(imgBackground, 0, 0, Constants.WINDOW_WIDTH, Constants.WINDOW_HEIGHT, null);
